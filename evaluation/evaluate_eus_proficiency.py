#!/usr/bin/env python3
"""
Evaluate multiple models on EusProficiency dataset:
1. Original Latxa
...
def main():
    ...
    # Load dataset
    print("Loading EusProficiency dataset...")
    ...
    results_file = f"results/eusproficiency_{args.model}_{args.shots}shot.jsonl"
