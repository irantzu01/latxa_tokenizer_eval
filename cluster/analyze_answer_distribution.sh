...
python evaluation/analyze_answer_distribution.py \
    results/eusexams_latxa_original_5shot_summary.jsonl \
    results/eusexams_latxa_dynamic_5shot_summary.jsonl \
    results/eusexams_latxa_basque_tokenizer_5shot_summary.jsonl \
    results/eusexams_latxa_basque_focus_5shot_summary.jsonl \
